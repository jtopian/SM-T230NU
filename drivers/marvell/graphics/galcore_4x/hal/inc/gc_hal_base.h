...
typedef struct _gcsPLS
{
    ...
    /* Game patch for SurfaceFlinger. */
    gctBOOL                     bSurfaceFlinger;

    /*Game patch for Google map */
    gctBOOL                     bGoogleMap;

    gctBOOL                     bNeedSkipFrame;

    gctBOOL                     bEnableNoResolve;

    gctBOOL                     bForceRenderTarget2RGB565;
