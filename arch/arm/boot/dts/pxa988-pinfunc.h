...
#define MFP_PULL_FLOAT_SLOW0      DS_SLOW0;PULL_FLOAT;EDGE_NONE;LPM_NONE
...
#define SM_BEN1			SM_BE1
#define GPIO101		DF_nCS0_SM_nCS2
#define GPIO61		DF_IO14
#define GPIO60		DF_IO15
